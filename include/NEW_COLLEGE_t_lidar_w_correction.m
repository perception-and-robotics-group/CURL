function point_cloud_out = NEW_COLLEGE_t_lidar_w_correction(pcd_file_name,frame_num,poses,pose_correction_dir,point_cloud)
%     pose_correction = load([pose_correction_dir '/' num2str(frame_num-1) '/transformationMatrix.txt']);
    ...
    point_cloud_out = inv(pose_correction*t_w_base*t_base_lidar)*[point_cloud ones(length(point_cloud),1)]';
